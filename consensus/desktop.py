...
class DesktopBridge:
    ...
    def update_provider(self, provider_id: str, name: str = "",
                        base_url: str = "",
    ...
    def save_entity(self, name: str, entity_type: str,
                    ...
                    system_prompt: str = "", entity_id: str = "") -> Optional[dict]:
    ...
    # -- Discussion setup --
    def add_to_discussion(self, entity_id: str, is_moderator: bool = False,
